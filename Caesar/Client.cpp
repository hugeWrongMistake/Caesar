...
void HookClient()
{
	...
	PreS_DynamicSound_s = (PreS_DynamicSound_t)DetourAttach((PVOID*)g_Offsets.PreS_DynamicSound(), (PVOID)&PreS_DynamicSound);
	CL_Move_s = (CL_Move_t)DetourAttach((PVOID*)g_Offsets.CL_Move(), (PVOID)&CL_Move);
